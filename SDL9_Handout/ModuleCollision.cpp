...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_WALL][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_HITBOX_2] = true;
	matrix[COLLIDER_ENEMY][COLLIDER_HITBOX_3] = true;
	...
	matrix[COLLIDER_REDOVNI][COLLIDER_HITBOX_2] = true;
	matrix[COLLIDER_REDOVNI][COLLIDER_HITBOX_3] = true;
	...
	matrix[COLLIDER_NINJA][COLLIDER_HITBOX_2] = true;
	matrix[COLLIDER_NINJA][COLLIDER_HITBOX_3] = true;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_PLAYER_2_SHOT][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_PLAYER_2_SHOT][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_PLAYER_3_SHOT][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_PLAYER_3_SHOT][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_HITBOX][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_HITBOX][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_HITBOX_2][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_HITBOX_2][COLLIDER_REDOVNI] = true;
	matrix[COLLIDER_HITBOX_2][COLLIDER_NINJA] = true;
	matrix[COLLIDER_HITBOX_2][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_PLAYER_2_SHOT] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_PLAYER_3_SHOT] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_ENEMY_SHOT] = true;
	matrix[COLLIDER_HITBOX_2][COLLIDER_HITBOX] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_HITBOX_3] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_POWER_UP] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_COIN] = false;
	matrix[COLLIDER_HITBOX_2][COLLIDER_TRIGGER] = false;

	matrix[COLLIDER_HITBOX_3][COLLIDER_WALL] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_HITBOX_3][COLLIDER_REDOVNI] = true;
	matrix[COLLIDER_HITBOX_3][COLLIDER_NINJA] = true;
	matrix[COLLIDER_HITBOX_3][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_PLAYER_2_SHOT] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_PLAYER_3_SHOT] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_ENEMY_SHOT] = true;
	matrix[COLLIDER_HITBOX_3][COLLIDER_HITBOX] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_HITBOX_3] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_POWER_UP] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_COIN] = false;
	matrix[COLLIDER_HITBOX_3][COLLIDER_TRIGGER] = false;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_HITBOX_2] = true;
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_HITBOX_3] = true;
	...
	matrix[COLLIDER_POWER_UP][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_POWER_UP][COLLIDER_HITBOX_3] = false;
	...
	matrix[COLLIDER_COIN][COLLIDER_HITBOX_3] = true;
	...
	matrix[COLLIDER_TRIGGER][COLLIDER_HITBOX_2] = false;
	matrix[COLLIDER_TRIGGER][COLLIDER_HITBOX_3] = false;
